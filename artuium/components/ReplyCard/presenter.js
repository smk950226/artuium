...
class ReplyCard extends Component {
  ...
  _renderFollowerList = () => {
    return <FollowerList user={this.props.reply.author} />;
  };

  _renderFollowingList = () => {
    return <FollowingList user={this.props.reply.author} />;
  };
          ...
          <Fragment>
            <View
              ...
              <TouchableWithoutFeedback onPress={this.props.openProfileModal}>
                <View
                  style={[{width: 40}, styles.alignItemsCenter, styles.mr15]}>
              ...
              <View
                ...
                <TouchableOpacity onPress={() => this._handleGoOthersProfile()}>
                  {reply.author.background_image ? (
                    <Image
                      source={{uri: reply.author.background_image}}
                      resizeMode={'cover'}
                      style={[
