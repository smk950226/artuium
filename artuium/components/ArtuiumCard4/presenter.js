          ...
          <View>
              ...
              {artwork.size === 'horizontal' && (
                <Fragment>
                  ...
                  <View
                    style={[
                      {
                        ...
                        maxWidth: width > 364 ? 364 : width * 0.9,
                        maxHeight:
                          width > 364 ? 246 : (246 * width * 0.9) / 364,
                        position: 'absolute',
                      },
                      styles.center,
                    ]}>
                    {is_liked ? (
                      <Image
                        source={require('../../assets/images/frame_horizontal_active.png')}
                        style={{
                          width:
                            width > 364 ? 364 * ratio : width * 0.9 * ratio,
                          height:
                            width > 364
                              ? 246 * ratio
                              : ((246 * width * 0.9) / 364) * ratio,
                      ...
                      <Image
                        source={require('../../assets/images/frame_horizontal_inactive.png')}
                        style={{
                          width:
                            width > 364 ? 364 * ratio : width * 0.9 * ratio,
                          height:
              ...
              {artwork.size === 'square' && (
                <Fragment>
                  ...
                  <View
                    style={[
                      {
                        ...
                        maxWidth: width > 240 ? 240 : width * 0.9,
                        maxHeight:
                          width > 240 ? 240 : (240 * width * 0.9) / 240,
                        position: 'absolute',
                      },
                      styles.center,
                    ]}>
                    {is_liked ? (
                      <Image
                        source={require('../../assets/images/frame_square_active.png')}
                        style={{
                          width:
                            width > 240 ? 240 * ratio : width * 0.9 * ratio,
                          height:
                            width > 240
                              ? 240 * ratio
                              : ((240 * width * 0.9) / 240) * ratio,
                      ...
                      <Image
                        source={require('../../assets/images/frame_square_inactive.png')}
                        style={{
                          width:
                            width > 240 ? 240 * ratio : width * 0.9 * ratio,
                          height:
              ...
              {artwork.size === 'vertical' && (
                <Fragment>
                  ...
                  <View
                    style={[
                      {
                        ...
                        maxWidth: width > 235 ? 235 : width * 0.9,
                        maxHeight:
                          width > 235 ? 355 : (355 * width * 0.9) / 235,
                        position: 'absolute',
                      },
                      styles.center,
                    ]}>
                    {is_liked ? (
                      <Image
                        source={require('../../assets/images/frame_vertical_active.png')}
                        style={{
                          width:
                            width > 235 ? 235 * ratio : width * 0.9 * ratio,
                          height:
                            width > 235
                              ? 355 * ratio
                              : ((355 * width * 0.9) / 235) * ratio,
                      ...
                      <Image
                        source={require('../../assets/images/frame_vertical_inactive.png')}
                        style={{
                          width:
                            width > 235 ? 235 * ratio : width * 0.9 * ratio,
                          height:
            ...
            <View style={[styles.alignItemsCenter, {marginTop: 30 * ratioV}]}>
              ...
              <View
                ...
                <Text
                  style={[styles.fontBold, styles.font30, styles.textCenter]}>
                  {artwork.name}
                </Text>
              </View>
              <Text
                style={[styles.fontMedium, styles.font14, {marginBottom: 150}]}>
                {artwork.author ? artwork.author.name : ''},{' '}
                {`${artwork.created.slice(0, 4)}`}, {artwork.material}
              </Text>
            </View>
          </View>
        </View>
