...
class ExhibitionContentScreen extends React.Component {
  ...
  render() {
    ...
    return exhibition ? (
      <View style={[styles.container, {flex: 1, width: deviceInfo.size.width}]}>
        <TouchableWithoutFeedback
        ...
        <ScrollView
          ...
          <ImageBackground
            resizeMode={'cover'}
            source={{
              uri: exhibition.images
                ? exhibition.images.length > 0
                  ? exhibition.images[0].image
                  : ''
                : '',
            }}
            style={[
              ...
              {height: height * 0.25, width: deviceInfo.size.width},
            ]}
          />
                ...
                <>
                  <View style={{marginTop: 39, alignItems: 'center'}}>
                    {checkIsActiveExhibition(
                      exhibition.open_date,
                      exhibition.close_date,
                    ) && (
                      <View
                        style={{
                          alignItems: 'center',
                    ...
                    <Text
                      ...
                      {`${exhibition.open_date.slice(
                        ...
                        8,
                        10,
                      )} ~ ${exhibition.close_date.slice(
                        0,
                        4,
                      )}.${exhibition.close_date.slice(
                        5,
                        7,
                      )}.${exhibition.close_date.slice(8, 10)}`}
                    </Text>
                    <View
                      style={{
                        flexDirection: 'row',
                  ...
                  {this.renderDotLine()}
                  <View
                    style={[styles.row, styles.mt15, {marginHorizontal: 18}]}>
                    <TouchableWithoutFeedback
                      onPress={() =>
                        this.setState({
                          index: 0,
                  ...
                  <>
                    <View
                      ...
                      <View style={[styles.row]}>
                        <Text
                          style={[
                            {width: 60, marginRight: 20, fontWeight: '500'},
                            styles.fontRegular,
                            styles.font14,
                          ]}>
                          전시 기간
                        ...
                        <Text
                          ...
                          5,
                          7,
                        )}.${exhibition.close_date.slice(8, 10)}`}</Text>
                      </View>
                      ...
                      <View style={[styles.row, styles.mt5]}>
                        ...
                        <Text
                          style={[
                            ...
                            styles.ml10,
                            {width: width - 180},
                          ]}>{`${exhibition.open_time.slice(
                          0,
                          5,
                        )} - ${exhibition.close_time.slice(0, 5)}`}</Text>
                      </View>
                      <View style={[styles.row, styles.mt5]}>
                        <Text
                          style={[
                    ...
                    <View
                      style={[
                        {marginTop: 25, width: width - 50, alignSelf: 'center'},
                      ]}>
                      ...
                      <View style={[styles.pb30]}>
                        ...
                        {loadingReply ? (
                          ...
                          <FlatList
                            ...
                            onEndReached={
                              hasNextPageReply ? this.props.replyListMore : null
                            }
                            onEndReachedThreshold={0.5}
                            bounces={true}
                            ListFooterComponent={
