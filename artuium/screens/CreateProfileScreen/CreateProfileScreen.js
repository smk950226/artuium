...
const TermModal = props => {
  ...
  return (
    <Modal
      ...
      style={{
        ...createProfileScreenStyles.modalContainer,
        marginTop: 91,
        marginBottom: 75,
        marginHorizontal: 17,
      }}>
      <Text
        style={{
          ...createProfileScreenStyles.modalTitle,
          marginTop: 17,
          marginLeft: 21,
        }}>
        {modalTitle}
      ...
      <ScrollView style={{marginTop: 21, paddingHorizontal: 21}}>
        <Text style={{...createProfileScreenStyles.modalText}}>
          {modalContent}
        </Text>
      </ScrollView>
      <TouchableOpacity
        style={{
          ...createProfileScreenStyles.modalButton,
          marginTop: 25,
          marginBottom: 17,
        }}
        onPress={() => setModalVisible(false)}>
        <Text style={{...createProfileScreenStyles.modalButtonText}}>확인</Text>
      </TouchableOpacity>
    </Modal>
  );
};
...
const EnterButton = props => {
  ...
  return (
    <TouchableOpacity
      ...
      onPress={onPress}
      style={{
        ...createProfileScreenStyles.enterButtonContainer,
        ...styles,
        backgroundColor: disabled || isLoading ? '#a7a7a7' : '#fd4c1e',
      }}>
      <Text style={{...createProfileScreenStyles.enterButtonText}}>
        {isLoading ? '로딩 중' : '입장하기'}
      </Text>
    </TouchableOpacity>
  );
...
const CreateProfileScreen = props => {
  ...
  const handleCheckNickname = checkingNickname => {
    ...
    setValidNickname(reg.test(checkingNickname));
  ...
  const handleCheckPrivacyPolicyTerm = () => {
    setPrivacyPolicy(!privacyPolicy);
  };

  const handleCheckServiceTerm = () => {
    setService(!service);
  };
      ...
      <LinearGradient
        ...
        <View
          ...
          <Image
            ...
            source={require('../../assets/images/artuiumLogoGray.png')}></Image>
          <DashLine />
          <TouchableOpacity
            style={{
              marginTop: 28.1,
          ...
          <View style={{marginTop: 12, marginHorizontal: 25, height: 55}}>
            ...
            />
            <Line color={validNickname ? '#2c2c2c' : '#ff5555'} />
            <Text
              style={{
                marginTop: 4.5,
                marginLeft: 8.5,
              ...
              {validNickname ? ' ' : nicknameInvalidText}
            </Text>
          </View>
          <View
            style={{
            ...
            <Checkbox
              ...
              handleCheck={handleCheckPrivacyPolicyTerm}
            />
          ...
          <View
            ...
            <Checkbox checked={service} handleCheck={handleCheckServiceTerm} />
            <Text style={{...createProfileScreenStyles.checkboxLabel}}>
              <Text
          ...
          <View
            ...
            <Checkbox
              ...
              handleCheck={handleCheckAllTerm}
            />
            <Text style={{...createProfileScreenStyles.checkboxLabel}}>
              전체 동의합니다.
            </Text>
          ...
          <EnterButton
            ...
            disabled={!(privacyPolicy && service && validNickname)}
          />
        </View>
      </LinearGradient>
    </ScrollView>
...
const termsText = {
  privacyPolicy: `<포브(Fov)>('www.artuium.com'이하 '아틔움')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
