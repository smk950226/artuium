...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    getArtworkReviewListMore: (artworkId, filter, page) => {
      return dispatch(
        artworkActions.getArtworkReviewListMore(artworkId, filter, page),
      );
    },
    createArtworkReview: (artworkId, rating, expression, content, title) => {
      return dispatch(
        artworkActions.createArtworkReview(
          artworkId,
          rating,
          expression,
          content,
    ...
    updateArtworkReview: (
      ...
      return dispatch(
        artworkActions.updateArtworkReview(
          artworkId,
          reviewId,
          rating,
          expression,
