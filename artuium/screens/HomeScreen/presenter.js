        ...
        return (
            <View style={[styles.container]}>
                ...
                <Animated.View
                    ...
                    <Animated.Image style={{opacity: headerOpacity, height: 40}} resizeMode={'contain'} source={require('../../assets/images/icon_horizontal.png')} />
                ...
                {changedScrollView ? (
                    <ScrollView>
                        <Animated.ScrollView { ...this.bannerResponder.panHandlers } scrollEventThrottle={16} horizontal={true} pagingEnabled={true} style={[styles.bgWhite, {width, height: height - 500, zIndex: 99, position: 'absolute', top: 0}, {transform: [{ translateY: this.state.containerPosition.y },{ scale: 1.0 }]}]} >
                    ...
                    initial ? (
                        ...
                        <Animated.View style={[styles.center, styles.alignSelfCenter, styles.bgWhite, styles.homeMenuShadow,
                            {width: menuWidth, height: 80, zIndex: 10, borderRadius: menuRadius, position: 'absolute', bottom: menuPosition, transform: [{ translateY: this.state.containerPosition.y },{ scale: 1.0 }]}
                        ]}>
                            <View style={[styles.row, styles.spaceAround, styles.width80]}>
                                <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('RecommendArtwork')}>
                                    <View style={[styles.center, { zIndex: 999 }]}>
