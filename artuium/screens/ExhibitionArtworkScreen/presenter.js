...
class ExhibitionArtworkScreen extends Component {
  ...
  render() {
    ...
    return (
      <ImageBackground
        style={[styles.center, styles.heightFull, styles.screenWidth]}
          ...
          <Fragment>
            <View
              ...
              <TouchableWithoutFeedback
                ...
                <View
                  style={[styles.row, styles.alignItemsCenter, {zIndex: 10}]}>
                  <Image
                    source={require('../../assets/images/icon_back_gray.png')}
              ...
              {showingIndex !== artworks.length - 1 && (
                <TouchableWithoutFeedback
                  ...
                  <View style={[styles.exitBtn, {zIndex: 999}]}>
                    <Text
                      style={[styles.fontBold, styles.font16, styles.white]}>
                      나가기
                    </Text>
                  </View>
                </TouchableWithoutFeedback>
                ...
                if (index === artworks.length - 1) {
                  return (
                    <ScrollView
                      ...
                      showsVerticalScrollIndicator={false}
                      style={[
                        {height: height - (135 + height * 0.17 * ratioV)},
                        styles.screenWidth,
                        styles.px30,
                      ]}>
                      <Text style={[styles.fontBold, styles.font35]}>
                        {exhibition.name}
                      </Text>
                      <View
                        style={[
                        ...
                        <View
                          ...
                          <Text
                            ...
                            {exhibition.total_rate.toFixed(2)}
                          </Text>
                        </View>
                        <TouchableWithoutFeedback
                          onPress={
                          ...
                          <View
                            ...
                            <Image
                              source={
                                is_liked
                                  ? require('../../assets/images/icon_heart_red.png')
                                  : require('../../assets/images/icon_heart_gray.png')
                              }
                              style={[{width: 107 * 0.4, height: 99 * 0.4}]}
                            />
              ...
              {showingIndex !== artworks.length - 1 ? (
                ...
                <TouchableWithoutFeedback
                  ...
                  <View style={[styles.relatedBtn]}>
                    <Text
                      style={[styles.fontMedium, styles.font18, styles.white]}>
                      전시 나가기
                    </Text>
                  </View>
                </TouchableWithoutFeedback>
            ...
            <View
              ...
              <TouchableWithoutFeedback
                ...
                <View style={[styles.mt30]}>
                  <Image
                    source={require('../../assets/images/arrow_up_exhibition.png')}
                    style={[styles.upBtn]}
                  />
                </View>
              </TouchableWithoutFeedback>
