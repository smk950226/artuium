...
class LoginScreen extends React.Component {
    ...
    _signUpNext = () => {
        const { username, password1, password2, usernameForm, checkedUsername, isCheckingUsername, passwordForm, passwordMatch, agreeTerm } = this.props;
    ...
    render(){
        const { isCheckingUsername, isCheckingNickname, isSubmitting, agreeTerm, showTerm } = this.props;
        return(
            <ImageBackground source={require('../../assets/images/bg_login.jpg')} resizeMode={'cover'} style={[styles.container, styles.center]}>
                ...
                <Modal
                    ...
                    style={[styles.center, {paddingBottom: 20}]}
                >
                    {showTerm ? (
...
○ 본 방침은부터 *2019*년 *12*월 *17*일부터 시행됩니다.
