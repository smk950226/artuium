...
function checkNickname(nickname) {
  return dispatch => {
    return fetch(
      `${FETCH_URL}/api/users/check/nickname/?nickname=${nickname}`,
      {
        headers: {
          'Content-Type': 'application/json',
        },
...
function followerList(userId) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/follower/list/?userId=${userId}&page=1`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function followerListMore(userId, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/follower/list/?userId=${userId}&page=${page}`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function followingList(userId) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/following/list/?userId=${userId}&page=1`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function followingListMore(userId, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/following/list/?userId=${userId}&page=${page}`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function changeProfile(nickname, statusMessage, profileImg, backgroundImg) {
  return (dispatch, getState) => {
    const {
      user: {token},
    } = getState();
...
function checkUsername(username) {
  return dispatch => {
    return fetch(
      `${FETCH_URL}/api/users/check/username/?username=${username}`,
      {
        headers: {
          'Content-Type': 'application/json',
        },
...
function getReplyList(reviewId, filter) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/reply/?reviewId=${reviewId}&filter=${filter}&page=1`,
      {
        headers: {
          Authorization: `JWT ${token}`,
          'Content-Type': 'application/json',
...
function getReplyListMore(reviewId, filter, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/reply/?reviewId=${reviewId}&filter=${filter}&page=${page}`,
      {
        headers: {
          Authorization: `JWT ${token}`,
          'Content-Type': 'application/json',
...
function getRepliesList(replyId, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/replies/?replyId=${replyId}&page=${page}`,
      {
        headers: {
          Authorization: `JWT ${token}`,
          'Content-Type': 'application/json',
