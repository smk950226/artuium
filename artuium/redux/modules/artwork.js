...
function getArtworkReviewList(artworkId, filter) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/review/artwork/?artworkId=${artworkId}&filter=${filter}&page=1`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function getArtworkReviewListMore(artworkId, filter, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/review/artwork/?artworkId=${artworkId}&filter=${filter}&page=${page}`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
...
function createArtworkReview(artworkId, rating, expression, content, title) {
  return (dispatch, getState) => {
    const {
      user: {token},
    } = getState();
...
function getArtworkLikeListMore(userId, page) {
  return (dispatch, getState) => {
    ...
    return fetch(
      `${FETCH_URL}/api/statics/like/artwork/${userId}/?page=${page}`,
      {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `JWT ${token}`,
